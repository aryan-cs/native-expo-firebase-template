# Updated Template with Bottom Tabs, Auth Flow, and Firebase Storage

Updated to work with the new version of expo (SDK 51, as of 05/15/2024). Simply create a Firebase project and enable Authentication to start. Below are the original notes from [@codingki](https://www.github.com/codingki)'s templates repository with minor changes to reflect new expo-related procedures.
